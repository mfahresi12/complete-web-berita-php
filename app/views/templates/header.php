...
<body class="d-flex flex-column" style="min-height: 100vh">
    ...
    <header class="sticky-top bg-dark border-bottom" id=header-main>
        <nav class="navbar navbar-main navbar-expand-lg navbar-light" id="navbar-main">
            <div class="container">
                ...
                <a class="navbar-brand" href="<?= base_url ?>">
                    <img alt="TusBall" src=<?= base_url ?>/logo/logo-text.png class="mt-n2" id=navbar-logo
                ...
                <div class="collapse navbar-collapse navbar-collapse-overlay" id="navbar-main-collapse">
                    ...
                    <ul class="navbar-nav ml-lg-auto">
                        ...
                        <a class="nav-link text-white" href="<?= base_url ?>/selengkapnya">Berita</a>
                        <a class="nav-link text-white" href="<?= base_url ?>/kritik">Kritik dan Saran</a>
                        <a class="nav-link text-white" href="<?= base_url ?>/bukutamu">Buku Tamu</a>
                    </ul>
                ...
                <div class="collapse navbar-collapse" id="navbar-info">
                    <ul class="navbar-nav">
                        <li class="nav-item d-flex align-items-center">
                            <a class="nav-link bg-danger rounded py-2 px-3 mr-3" href="<?= base_url ?>">
                                <span class="nav-link-inner--text text-white">Kategori Liga</span>
                            </a>
                        </li>
    
                        <?php foreach(GetKategori::get() as $item){ ?>
                            <li class="nav-item mx-2"> <!-- Tambahkan margin antar item -->
                                <a class="nav-link nav-link-icon" href="<?= base_url ?>/<?= strtolower($item['kategori']) ?>">
                                    <div class="bg-custom">
                                        <span class="nav-link-inner--text text-dark"><?= $item['kategori'] ?></span>
                                    </div>
                                </a>
