...
<div class="container mt-5 mb-5">
    <div class="row mb-5 justify-content-center text-center">
        <div class="col-lg-8 col-md-10">
            <h2 class="mt-4 text-primary">Berita Bola Terbaru</h2>
            <div class="mt-2">
                <p class="lead lh-180">Berita bola terkini, terpercaya dan terakurat.</p>
            </div>
        </div>
    </div>
...
<div class="container mt-5 mb-5">
    <div class="row mb-5 justify-content-center text-center">
        <div class="col-lg-8 col-md-10">
            <h2 class="mt-4 text-primary">Tim Kreator</h2>
        </div>
    </div>
    ...
    <div class="row">
        <?php foreach([
            [
                'nama' => 'Muhammad Fahresi',
                'gambar' => 'img/resi.jpg',
                'instagram' => 'https://www.instagram.com/muh_fahresi/',
            ],
            ...
            <div class="col-lg-3 col-sm-6 mb-5">
                <div data-animate-hover="2">
                    ...
                    <div class="mt-3">
                        ...
                        <p class="text-muted text-sm mb-0">Penulis dan Admin</p>
